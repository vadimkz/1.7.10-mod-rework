...
/*  59 */     this.blockIcon = reg.registerIcon("magicalcrops:furnacezivicio_side");
/*  60 */     this.iconFront = reg.registerIcon(this.isBurning2 ? "magicalcrops:furnacezivicio_front_on" : "magicalcrops:furnacezivicio_front_off");
/*  61 */     this.iconTop = reg.registerIcon("magicalcrops:furnacezivicio_top");
/*     */   }
/*     */ 
/*     */   
...
/*  72 */     return Item.getItemFromBlock(MBlocks.ZivicioFurnace);
/*     */   }
/*     */ 
/*     */   
/*     */   public Item getItem(World world, int par2, int par3, int par4) {
/*  77 */     return Item.getItemFromBlock(MBlocks.ZivicioFurnace);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  90 */     func_149930_e(worldIn, x, y, z);
/*     */   }
/*     */ 
/*     */   
...
/* 164 */     if (p_149931_0_) {
/*     */       
/* 166 */       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.ZivicioFurnaceActive);
/*     */     }
/*     */     else {
/*     */       
/* 170 */       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.ZivicioFurnace);
/*     */     } 
/*     */     
/* 173 */     isBurning = false;
...
/* 184 */     if (!isBurning) {
/* 185 */       TileEntityZivicioFurnace tileentityZivicioFurnace = (TileEntityZivicioFurnace)world.getTileEntity(x, y, z);
/*     */       
/* 187 */       if (tileentityZivicioFurnace != null) {
/* 188 */         for (int i = 0; i < tileentityZivicioFurnace.getSizeInventory(); i++) {
/* 189 */           ItemStack itemstack = tileentityZivicioFurnace.getStackInSlot(i);
/*     */           
