...
/*  59 */     this.field_149761_L = p_149651_1_.func_94245_a("magicalcrops:furnacezivicio_side");
/*  60 */     this.field_149936_O = p_149651_1_.func_94245_a(this.isBurning2 ? "magicalcrops:furnacezivicio_front_on" : "magicalcrops:furnacezivicio_front_off");
/*  61 */     this.field_149935_N = p_149651_1_.func_94245_a("magicalcrops:furnacezivicio_top");
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean func_149727_a(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
/*  66 */     player.openGui(MagicalCrops.instance, 4, world, x, y, z);
/*  67 */     return true;
/*     */   }
/*     */ 
/*     */   
/*     */   public Item func_149650_a(int par1, Random random, int par3) {
/*  72 */     return Item.func_150898_a(MBlocks.ZivicioFurnace);
/*     */   }
/*     */ 
/*     */   
/*     */   public Item func_149694_d(World world, int par2, int par3, int par4) {
/*  77 */     return Item.func_150898_a(MBlocks.ZivicioFurnace);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public TileEntity func_149915_a(World world, int par2) {
/*  83 */     return new TileEntityZivicioFurnace();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 164 */     if (p_149931_0_) {
/*     */       
/* 166 */       p_149931_1_.func_147449_b(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.ZivicioFurnaceActive);
/*     */     }
/*     */     else {
/*     */       
/* 170 */       p_149931_1_.func_147449_b(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.ZivicioFurnace);
/*     */     } 
/*     */     
/* 173 */     isBurning = false;
...
/* 184 */     if (!isBurning) {
/* 185 */       TileEntityZivicioFurnace tileentityZivicioFurnace = (TileEntityZivicioFurnace)world.func_147438_o(x, y, z);
/*     */       
/* 187 */       if (tileentityZivicioFurnace != null) {
/* 188 */         for (int i = 0; i < tileentityZivicioFurnace.func_70302_i_(); i++) {
/* 189 */           ItemStack itemstack = tileentityZivicioFurnace.func_70301_a(i);
/*     */           
...
/* Location:              C:\Users\Вадим\AppData\Roaming\.minecraft\versions\testcrop\mods\magicalcrops-4.0.0_PUBLIC_BETA_3.jar!\com\mark719\magicalcrops\furnace\ZivicioFurnace.class
