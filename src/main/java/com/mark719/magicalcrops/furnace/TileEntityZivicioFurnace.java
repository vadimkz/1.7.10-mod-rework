...
/**
 * TileEntity for the Zivicio Furnace from Magical Crops.
 * This furnace is designed to be extremely fast (12 ticks per operation vs 200 in vanilla).
 */
public class TileEntityZivicioFurnace extends TileEntity implements ISidedInventory {
    ...
    public ItemStack decrStackSize(int slot, int count) {
        if (this.furnaceItemStacks[slot] != null) {
            ...
            ItemStack itemstack = this.furnaceItemStacks[slot].splitStack(count);
    ...
    public int getCookProgressScaled(int pixels) {
        // Zivicio Furnace cook time is 12 ticks
        return this.furnaceCookTime * pixels / 12;
    }
    ...
    public int getBurnTimeRemainingScaled(int pixels) {
        ...
        return this.furnaceBurnTime * pixels / this.currentBurnTime;
    }
        ...
        if (!this.worldObj.isRemote) {
            if (this.furnaceBurnTime != 0 || this.furnaceItemStacks[1] != null && this.furnaceItemStacks[0] != null) {
                ...
                if (this.isBurning() && this.canSmelt()) {
                    ...
                    // Check if cooking is finished (12 ticks)
