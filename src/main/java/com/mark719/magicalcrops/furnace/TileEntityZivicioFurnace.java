...
public class TileEntityZivicioFurnace extends TileEntity implements ISidedInventory {
    ...
    public String getInventoryName() {
        return hasCustomInventoryName() ? this.customName : "Zivicio Furnace";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (wasBurning != isBurning()) {
                dirty = true;
                ZivicioFurnace.updateBlockState(isBurning(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
