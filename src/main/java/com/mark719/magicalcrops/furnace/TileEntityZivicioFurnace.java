...
/* 113 */     return isCustomInventoryName() ? this.furnaceName : "Zivicio Furnace";
/*     */   }
/*     */ 
/*     */   
...
/* 184 */     return this.furnaceCookTime * scale / 12;
/*     */   }
/*     */ 
/*     */   
/*     */   @SideOnly(Side.CLIENT)
...
/*     */         
/* 256 */         flag1 = true;
/* 257 */         ZivicioFurnace.updateBlockState((this.furnaceBurnTime > 0), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
/*     */       } 
/*     */     } 
/*     */     
/* 261 */     if (flag1)
