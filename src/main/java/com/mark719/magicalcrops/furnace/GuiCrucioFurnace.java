...
/*    */ public class GuiCrucioFurnace
/*    */   extends GuiContainer
/*    */ {
/* 18 */   private static final ResourceLocation texture = new ResourceLocation("magicalcrops".toLowerCase(), "textures/gui/crucio_furnace_gui.png");
/*    */   private TileEntityCrucioFurnace tileFurnace;
/*    */   
/*    */   public GuiCrucioFurnace(InventoryPlayer invPlayer, TileEntityCrucioFurnace tile) {
/* 22 */     super(new ContainerCrucioFurnace(invPlayer, tile));
...
/* 29 */     this.fontRendererObj.drawString(string, 138 - this.fontRendererObj.getStringWidth(string), 6, 4210752);
...
/* Location:              C:\Users\Вадим\AppData\Roaming\.minecraft\versions\testcrop\mods\magicalcrops-4.0.0_PUBLIC_BETA_3.jar!\com\mark719\magicalcrops\furnace\GuiCrucioFurnace.class
