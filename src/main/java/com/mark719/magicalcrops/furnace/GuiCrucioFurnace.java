...
public class GuiCrucioFurnace extends GuiContainer {
    private static final ResourceLocation texture = new ResourceLocation("magicalcrops", "textures/gui/crucio_furnace_gui.png");
    ...
    public GuiCrucioFurnace(InventoryPlayer invPlayer, TileEntityCrucioFurnace tile) {
        super(new ContainerCrucioFurnace(invPlayer, tile));
