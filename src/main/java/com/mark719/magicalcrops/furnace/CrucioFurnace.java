...
/*  59 */     this.blockIcon = p_149651_1_.registerIcon("magicalcrops:furnacecrucio_side");
/*  60 */     this.iconFront = p_149651_1_.registerIcon(this.isBurning2 ? "magicalcrops:furnacecrucio_front_on" : "magicalcrops:furnacecrucio_front_off");
/*  61 */     this.iconTop = p_149651_1_.registerIcon("magicalcrops:furnacecrucio_top");
/*     */   }
/*     */ 
/*     */   
...
/*  72 */     return Item.getItemFromBlock(MBlocks.CrucioFurnace);
/*     */   }
/*     */ 
/*     */   
/*     */   public Item getItem(World world, int par2, int par3, int par4) {
/*  77 */     return Item.getItemFromBlock(MBlocks.CrucioFurnace);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 164 */     if (p_149931_0_) {
/*     */       
/* 166 */       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.CrucioFurnaceActive);
/*     */     }
/*     */     else {
/*     */       
/* 170 */       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, MBlocks.CrucioFurnace);
/*     */     } 
/*     */     
/* 173 */     isBurning = false;
...
/* 184 */     if (!isBurning) {
/* 185 */       TileEntityCrucioFurnace tileentityCrucioFurnace = (TileEntityCrucioFurnace)world.getTileEntity(x, y, z);
/*     */       
/* 187 */       if (tileentityCrucioFurnace != null) {
/* 188 */         for (int i = 0; i < tileentityCrucioFurnace.getSizeInventory(); i++) {
/* 189 */           ItemStack itemstack = tileentityCrucioFurnace.getStackInSlot(i);
/*     */           
