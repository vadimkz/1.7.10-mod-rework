...
/* 113 */     return isCustomInventoryName() ? this.furnaceName : "Imperio Furnace";
/*     */   }
/*     */ 
/*     */   
...
/* 184 */     return this.furnaceCookTime * scale / 25;
/*     */   }
/*     */ 
/*     */   
/*     */   @SideOnly(Side.CLIENT)
...
/*     */         
/* 256 */         flag1 = true;
/* 257 */         ImperioFurnace.updateBlockState((this.furnaceBurnTime > 0), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
/*     */       } 
/*     */     } 
/*     */     
/* 261 */     if (flag1)
