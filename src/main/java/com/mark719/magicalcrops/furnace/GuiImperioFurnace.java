...
public class GuiImperioFurnace extends GuiContainer {
    private static final ResourceLocation texture = new ResourceLocation("magicalcrops", "textures/gui/imperio_furnace_gui.png");
    ...
    public GuiImperioFurnace(InventoryPlayer invPlayer, TileEntityImperioFurnace tile) {
        super(new ContainerImperioFurnace(invPlayer, tile));
