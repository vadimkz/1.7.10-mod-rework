...
/* 113 */     return isCustomInventoryName() ? this.furnaceName : "Ultimate Furnace";
/*     */   }
/*     */ 
/*     */   
...
/* 184 */     return this.furnaceCookTime * scale / 1;
/*     */   }
/*     */ 
/*     */   
/*     */   @SideOnly(Side.CLIENT)
...
/*     */         
/* 256 */         flag1 = true;
/* 257 */         UltimateFurnace.updateBlockState((this.furnaceBurnTime > 0), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
/*     */       } 
/*     */     } 
/*     */     
/* 261 */     if (flag1)
