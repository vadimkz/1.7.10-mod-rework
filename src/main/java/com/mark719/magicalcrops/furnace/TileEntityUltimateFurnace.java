...
public class TileEntityUltimateFurnace extends TileEntity implements ISidedInventory {
    ...
    public String getInventoryName() {
        return hasCustomInventoryName() ? this.customName : "Ultimate Furnace";
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (wasBurning != isBurning()) {
                dirty = true;
                UltimateFurnace.updateBlockState(isBurning(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
