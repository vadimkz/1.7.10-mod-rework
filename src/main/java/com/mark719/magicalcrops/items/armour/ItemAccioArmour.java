...
/*    */     }
/* 73 */     par3List.add(EnumChatFormatting.WHITE + "Durability: " + EnumChatFormatting.GRAY + EnumChatFormatting.ITALIC + "" + (getMaxDamage() - getDamage(par1ItemStack)) + "/" + getMaxDamage());
/*    */   }
/*    */ }
