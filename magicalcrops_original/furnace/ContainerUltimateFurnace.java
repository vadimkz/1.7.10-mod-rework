...
/*  24 */     func_75146_a(new Slot((IInventory)tileEntityUltimateFurnace, 0, 56, 17));
/*  25 */     func_75146_a(new Slot((IInventory)tileEntityUltimateFurnace, 1, 56, 53));
/*  26 */     func_75146_a((Slot)new SlotFurnace(player.field_70458_d, (IInventory)tileEntityUltimateFurnace, 2, 116, 35));
/*     */     
/*     */     int i;
/*  29 */     for (i = 0; i < 3; i++) {
...
/*  42 */     craft.func_71112_a(this, 0, this.tileUltimateFurnace.furnaceCookTime);
/*  43 */     craft.func_71112_a(this, 1, this.tileUltimateFurnace.furnaceBurnTime);
/*  44 */     craft.func_71112_a(this, 2, this.tileUltimateFurnace.currentBurnTime);
/*     */   }
/*     */   
...
/*  53 */         craft.func_71112_a(this, 0, this.tileUltimateFurnace.furnaceCookTime);
/*     */       }
/*     */       
/*  56 */       if (this.lastBurnTime != this.tileUltimateFurnace.furnaceBurnTime) {
/*  57 */         craft.func_71112_a(this, 1, this.tileUltimateFurnace.furnaceBurnTime);
/*     */       }
/*     */       
/*  60 */       if (this.lastItemBurnTime != this.tileUltimateFurnace.currentBurnTime) {
/*  61 */         craft.func_71112_a(this, 2, this.tileUltimateFurnace.currentBurnTime);
/*     */       }
/*     */     } 
/*     */     
...
/*  87 */     return this.tileUltimateFurnace.func_70300_a(player);
/*     */   }
/*     */ 
/*     */ 
/*     */   
